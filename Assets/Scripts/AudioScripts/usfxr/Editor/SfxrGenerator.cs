...
public class SfxrGenerator : EditorWindow {
	...
	public static void Initialize() {
		...
		window.titleContent.text = window.name = "Sound Effects";
		window.Show();
	}
	...
	public bool RenderParameters(SfxrParams parameters) {
		...
		try {
			...
			RenderSlider(+20, +20000, parameters.startFrequency, (value => parameters.startFrequency = value), new GUIContent("Start Frequency", "Base note of the sound (0 to 1)"));
